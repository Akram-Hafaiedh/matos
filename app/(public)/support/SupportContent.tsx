...
export default function SupportContent() {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        const subject = formData.get('ticket_subject') as string;
        const description = formData.get('ticket_description') as string;
        const priority = formData.get('ticket_priority') as string;
        const orderNumber = formData.get('ticket_order') as string;
