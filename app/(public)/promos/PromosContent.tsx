...
import {
    Tag, Flame, Zap, ShoppingBag, ArrowRight, Shield
} from 'lucide-react';
...
export default function PromosContent({ initialPromos }: PromosContentProps) {
    const { addToCart, setCartOpen } = useCart();
    const { toast } = useToast();
    const [promos] = useState<any[]>(initialPromos);
            ...
            <section className="max-w-7xl mx-auto px-6">
                        ...
                        >
                            <div className="flex flex-col md:flex-row gap-10 h-full">
                                <div className="md:w-1/2 relative">
                                    ...
                                    <Image
                                        src={promo.image || '/images/delivery.png'} // Fallback if no image
                                        alt={promo.title}
                                        width={400}
                                        height={400}
                ...
                {promos.length === 0 && (
                    <div className="py-40 text-center space-y-8 opacity-40">
                        ...
                        <h2 className="text-4xl font-[1000] uppercase italic tracking-tighter">Aucun deal actif</h2>
                        <p className="text-gray-500 font-bold uppercase tracking-widest text-xs">Revenez bientôt pour de nouvelles opportunités du Syndicat</p>
                    </div>
                )}
            </section>
