...
export default function PolicyContent({ page, sections }: { page: any, sections: any[] }) {
                ...
                >
                    <div className="space-y-6">
                        ...
                        >
                            ...
                            <span className="text-yellow-400 font-black text-[10px] uppercase tracking-[0.4em] italic">Centre de Confidentialité Mato's</span>
                        </motion.div>
                        ...
                        <div className="space-y-4">
                            <h1 className="text-5xl md:text-[8rem] font-[1000] italic uppercase tracking-tighter text-white leading-none flex flex-wrap items-center justify-center gap-x-8 gap-y-4">
                                <span>{page.title.split(' ').slice(0, 2).join(' ')}</span>
                                <motion.span
                ...
                <div className="relative z-10 pt-32 pb-16 flex flex-col items-center text-center text-black px-6">
                    <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 1 }} className="space-y-6">
                        ...
                        <h2 className="text-3xl md:text-5xl font-[1000] uppercase italic tracking-tighter leading-[0.9] max-w-2xl">
                            VOS DONNÉES SONT <br />
                            LA <span className="underline decoration-black/20">PRIORITÉ ABSOLUE</span> <br />
                            DE NOTRE ÉLITE.
                        </h2>
                        ...
                        <div className="pt-4">
                            <Link href="/menu" className="relative group overflow-hidden px-10 py-4 bg-black text-white font-[1000] uppercase italic tracking-widest rounded-full text-[10px] hover:scale-105 transition-all shadow-xl inline-block">
                                <span className="relative z-10">Continuer l'Experience</span>
                                <div className="absolute inset-0 flex items-center justify-center bg-white text-black translate-y-full group-hover:translate-y-0 transition-transform duration-500 z-20 font-black uppercase text-[10px]">Accès Sécurisé</div>
                            </Link>
                        </div>
                    </motion.div>
                </div>
