...
export default function ContactMessagesManagement() {
    ...
    return (
        <div className="w-full pb-20 space-y-12 animate-in fade-in duration-700 text-left">
            {/* Header */}
            <div className="flex flex-col xl:flex-row justify-between items-start xl:items-end gap-10">
                <div>
                    <div className="flex items-center gap-3 mb-2">
                        <Mail size={12} className="text-yellow-400" />
                        <span className="text-[10px] font-[1000] text-gray-500 uppercase tracking-[0.4em] italic">Intelligence Signals</span>
                    </div>
                    <h1 className="text-7xl font-[1000] text-white uppercase italic tracking-tighter leading-none mb-4">
                        Messages <span className="text-yellow-400">Contact</span>
                    </h1>
                    <p className="text-gray-700 font-bold uppercase text-[10px] tracking-[0.5em] ml-1">Archive des transmissions via le portail public</p>
                </div>
            </div>
                        ...
                        {selectedMessage ? (
                            ...
                            >
                                ...
                                <div className="flex flex-col md:flex-row justify-between items-start gap-8 relative z-10">
                                    <div className="space-y-4">
                                        <div className="flex items-center gap-6">
                                            ...
                                            />
                                            <div>
                                                <p className="text-[10px] font-black text-gray-500 uppercase tracking-widest italic mb-1">Origine du Message</p>
                                ...
                                <div className="flex justify-between items-center text-[10px] font-black text-gray-700 uppercase tracking-[0.3em] italic relative z-10 pt-4 border-t border-white/5">
                                    <div className="flex items-center gap-3">
                                        ...
                                        Message reçu le {new Date(selectedMessage.created_at).toLocaleString('fr-FR')}
                                    </div>
                            ...
                            <div className="h-full flex flex-col items-center justify-center text-center space-y-8 bg-white/[0.01] rounded-[4rem] border border-white/5 border-dashed relative overflow-hidden p-20">
                                ...
                                <div className="space-y-4 relative z-10">
                                    <h3 className="text-3xl font-[1000] text-gray-700 uppercase italic tracking-tighter">Aucune Sélection</h3>
                                    <p className="text-gray-800 font-bold uppercase text-[10px] tracking-[0.5em] italic">Sélectionnez un message pour lire son contenu</p>
                                </div>
                            </div>
                        )}
                    </AnimatePresence>
