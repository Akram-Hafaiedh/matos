...
import { Package, Clock, CheckCircle, Truck, XCircle, RefreshCw, LogOut, User } from 'lucide-react';
            ...
            <div className="max-w-7xl mx-auto px-4">
                ...
                <div className="flex items-center justify-between mb-8">
                    <div>
                        <h1 className="text-5xl font-black text-white mb-2">
                            Dashboard <span className="text-yellow-400">Commandes</span>
                        </h1>
                    ...
                    <div className="flex items-center gap-4">
                        {/* User Info */}
                        <div className="bg-gray-800 px-6 py-3 rounded-xl border-2 border-gray-700 flex items-center gap-3">
                            <User className="w-5 h-5 text-yellow-400" />
                            <div>
                                <p className="text-white font-bold text-sm">{session?.user?.name}</p>
                                <p className="text-gray-400 text-xs">{(session?.user as any)?.role}</p>
                            </div>
                        </div>
                        ...
                        <button
                            ...
                            className="bg-red-600 hover:bg-red-500 text-white px-6 py-3 rounded-xl font-bold flex items-center gap-2 transition"
                        >
                ...
                <div className="grid md:grid-cols-4 gap-6 mb-8">
                    <div className="bg-gradient-to-br from-yellow-500 to-amber-600 rounded-2xl p-6">
                        <p className="text-gray-900 font-bold mb-2">Total Commandes</p>
