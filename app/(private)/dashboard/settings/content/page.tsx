...
export default function ContentSettingsPage() {
    ...
    if (loading) return (
        <div className="min-h-[60vh] flex flex-col items-center justify-center space-y-6">
            ...
            <p className="text-[10px] font-black text-gray-500 uppercase tracking-[0.5em] italic">Lecture des archives statiques...</p>
        </div>
    );
            ...
            <div className="flex flex-col xl:flex-row justify-between items-start xl:items-end gap-10">
                <div>
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className="text-[10px] font-[1000] text-gray-500 uppercase tracking-[0.4em] italic">Static Archives Management</span>
                    </div>
                    <h1 className="text-7xl font-[1000] text-white uppercase italic tracking-tighter leading-none mb-4">
                        Contenu<span className="text-yellow-400"> Statique</span>
                    </h1>
                    <p className="text-gray-700 font-bold uppercase text-[10px] tracking-[0.5em] ml-1">Gestion des pages légales, mentions et politiques</p>
                </div>

                <div className="flex items-center gap-6">
                    <div className="text-right hidden sm:block">
                        <p className="text-[9px] font-[1000] text-gray-700 uppercase tracking-[0.4em] italic mb-1">Status Publication</p>
                        <p className="text-xs font-black text-yellow-400 italic uppercase">Archives Synchronisées</p>
                    </div>
                </div>
            </div>
